import {
  Modal, ModalOverlay, ModalContent, ModalHeader, ModalBody, VStack, FormControl, FormLabel, Input, RadioGroup, HStack, Radio, ModalFooter, Button,
...
}: { mode: 'Add' | 'Edit', initialValues: { name: string, kind: TallyKind }, isOpen: boolean, onConfirm: (name: string, kind: TallyKind) => void, onClose: () => void }) {
  return (
